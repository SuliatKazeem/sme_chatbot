...
def scan_domain(domain):
    ...
    return {
        ...
        "verdict": "⚠️ Likely Malicious" if stats.get("malicious", 0) > 0 else "✅ Looks Safe"
    }
...
def scan_url(url):
    ...
    return {
        ...
        "suspicious": stats.get("suspicious", 0),
        "harmless": stats.get("harmless", 0),
        "verdict": "⚠️ Likely Phishing" if stats.get("malicious", 0) > 0 else "✅ Looks Safe"
    }
...
def scan_file_attachment(filename, file_bytes):
    ...
    return {
        ...
        "suspicious": stats.get("suspicious", 0),
        "harmless": stats.get("harmless", 0),
        "verdict": "⚠️ Likely Malicious File" if stats.get("malicious", 0) > 0 else "✅ File Seems Safe"
    }
